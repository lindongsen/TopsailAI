...
start_server() {
    ...
    export ACS_DATABASE_SSLMODE="disable"
    ...
    # Allow integration-test mock agent commands to be resolved by bare name.
    export ACS_AGENT_SCRIPTS_PATH="${PROJECT_ROOT}/tests/integration"
