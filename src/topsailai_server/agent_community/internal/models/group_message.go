...
type GroupMessage struct {
	...
	MessageAttachments string      `gorm:"column:message_attachments;type:jsonb;default:'[]'" json:"message_attachments"`
	...
	Mentions          string       `gorm:"column:mentions;type:jsonb;default:'[]'" json:"mentions"`
