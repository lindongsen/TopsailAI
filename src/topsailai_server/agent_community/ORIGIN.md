...
GOAL: finish all of features.
1. 要有完整的测试，unit test, integration/manual api test, mock ai-agent server
2. 要有 cli-terminal, terminal 能连 nats，多members会话时，消息可以通过nats即时收到
