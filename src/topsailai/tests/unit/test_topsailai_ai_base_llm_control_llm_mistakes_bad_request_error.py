...
class TestMistakesDict:
    ...
    def test_mistakes_dict_exists(self):
        ...
        from topsailai.ai_base.llm_control.llm_mistakes.bad_request_error import MISTAKES
    ...
    def test_mistakes_dict_check_mistake1_reference(self):
        ...
        from topsailai.ai_base.llm_control.llm_mistakes.bad_request_error import MISTAKES, check_mistake1
