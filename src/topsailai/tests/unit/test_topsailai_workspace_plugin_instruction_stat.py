...
class TestShowToolCallStat(unittest.TestCase):
    ...
    def test_show_tool_call_stat_success(self, mock_print, mock_tool_stat, mock_get_ai_agent):
        ...
        mock_tool_stat.get_agent_tool_stat.return_value = self.mock_stat
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_show_tool_call_stat_with_tool_name(self, mock_print, mock_tool_stat, mock_get_ai_agent):
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_show_tool_call_stat_tool_not_found(self, mock_print, mock_tool_stat, mock_get_ai_agent):
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_show_tool_call_stat_empty(self, mock_print, mock_tool_stat, mock_get_ai_agent):
        ...
        mock_tool_stat.get_agent_tool_stat.return_value = mock_stat_empty
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_show_tool_call_stat_no_agent(self, mock_print, mock_tool_stat, mock_get_ai_agent):
        """Test show_tool_call_stat falls back to default stat when no agent is active"""
        from topsailai.workspace.plugin_instruction.stat import show_tool_call_stat

        mock_get_ai_agent.return_value = None
        mock_tool_stat.get_agent_tool_stat.return_value = self.mock_stat

        show_tool_call_stat()

        mock_print.assert_called_once()
        mock_tool_stat.get_agent_tool_stat.assert_called_once_with(None)
...
class TestShowToolCallErrors(unittest.TestCase):
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_show_tool_call_errors_success(self, mock_print, mock_tool_stat, mock_get_ai_agent):
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_show_tool_call_errors_with_tool_name(self, mock_print, mock_tool_stat, mock_get_ai_agent):
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_show_tool_call_errors_tool_not_found(self, mock_print, mock_tool_stat, mock_get_ai_agent):
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_show_tool_call_errors_empty(self, mock_print, mock_tool_stat, mock_get_ai_agent):
...
class TestLogToolCall(unittest.TestCase):
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_log_tool_call_success(self, mock_print, mock_tool_stat, mock_get_ai_agent):
        ...
        mock_tool_stat.get_agent_tool_stat.return_value = mock_stat
    ...
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    @patch("builtins.print")
    def test_log_tool_call_empty(self, mock_print, mock_tool_stat, mock_get_ai_agent):
...
class TestResetToolCall(unittest.TestCase):
    """Test cases for tool_call_reset instruction"""

    @patch("topsailai.workspace.plugin_instruction.stat.get_ai_agent")
    @patch("topsailai.workspace.plugin_instruction.stat.tool_stat")
    def test_tool_call_reset_resolves_current_stat_at_call_time(self, mock_tool_stat, mock_get_ai_agent):
        """tool_call_reset must resolve the active agent's ToolStat at invocation time,
        not capture a default instance at module import time."""
        from topsailai.workspace.plugin_instruction.stat import INSTRUCTIONS
        ...
        reset_handler = INSTRUCTIONS["tool_call_reset"]
        reset_handler()

        mock_tool_stat.get_agent_tool_stat.assert_called_once_with(mock_agent)
        mock_stat.reset.assert_called_once()
