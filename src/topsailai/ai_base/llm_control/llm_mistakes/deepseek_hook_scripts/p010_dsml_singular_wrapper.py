...
Created: 2026-08-10
Purpose: Case script for DeepSeek DSML singular wrapper.

Handles the malformed format where a single ``<｜DSML｜tool_call>`` opening tag is
paired with a singular ``</｜DSML｜tool_call>`` closing tag (see dsml-3.txt).
...
def main():
    """Entry point: parse the singular wrapper and print JSON or nothing."""
