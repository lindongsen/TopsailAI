...
class SessionData(object):
    ...
    its unique identifier, associated task, runtime environment paths, and
    accumulated token usage. Additional metadata like session name and
    creation time can be stored as attributes.
    """
    def __init__(
        self,
        session_id: str,
