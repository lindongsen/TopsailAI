...
def get_manager_name(manager_name:str=None) -> str:
    ...
    If the manager name is not provided, it will be read from the environment variable "TOPSAILAI_TEAM_MANAGER_NAME".
    ...
    """
    if not manager_name:
        manager_name = env_tool.EnvReaderInstance.get("TOPSAILAI_TEAM_MANAGER_NAME") \
