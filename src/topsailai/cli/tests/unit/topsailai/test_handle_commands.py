...
class TestRuntimeModeArguments(unittest.TestCase):
    """Tests for runtime mode (raw default / TUI) argument handling."""
    ...
    def test_default_uses_raw_mode(
        self,
