...
- `../workspace/agent/runtime_message_sources/file.py`
Key behaviors:
...
- `../workspace/agent/hooks/pre_run_agent2llm_source.py`
...
- `../ai_base/agent2llm_message_source.py`
...
- `../ai_base/agent2llm_message_source.py` — abstract source and `apply_agent2llm_message_source()`.
- `../workspace/agent/runtime_message_sources/file.py` — file-based implementation.
- `../workspace/agent/hooks/pre_run_agent2llm_source.py` — pre-run hook that installs the source.
